"""Linear SVM classifier (sklearn) with train/test and comparison outputs."""
...
MODEL_NAME = "svm"
DEFAULT_MODEL_PATH = "results/svm_model.pkl"
DEFAULT_METRICS_PATH = "results/svm_metrics.json"
DEFAULT_PLOT_PATH = "results/svm_confusion_matrix.png"


def parse_args():
    parser = argparse.ArgumentParser(description="Train/evaluate Linear SVM model.")
    ...
    parser.add_argument(
        "--predictions-path",
        default="results/svm_predictions.csv",
...
def save_confusion_plot(y_true, y_pred, plot_path: str):
    ...
    plt.title("Linear SVM — Burnout Level Confusion Matrix")
