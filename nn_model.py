"""Neural network model script with train/test and comparison outputs."""
...
MODEL_NAME = "nn"
DEFAULT_MODEL_PATH = "results/nn_model.pkl"
DEFAULT_METRICS_PATH = "results/nn_metrics.json"
DEFAULT_PLOT_PATH = "results/nn_confusion_matrix.png"


def parse_args():
    parser = argparse.ArgumentParser(description="Train/evaluate neural network model.")
    ...
    parser.add_argument(
        "--predictions-path",
        default="results/nn_predictions.csv",
...
def save_confusion_plot(y_true, y_pred, plot_path: str):
    ...
    plt.title("Neural Network — Burnout Level Confusion Matrix")
...
def main():
    ...
    if not args.test:
        ...
        model = MLPClassifier(hidden_layer_sizes=(64, 32), random_state=args.seed, max_iter=500)
